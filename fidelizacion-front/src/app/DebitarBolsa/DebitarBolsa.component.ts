...
@Component({
  selector: 'app-DebitarBolsa',
  templateUrl: './DebitarBolsa.component.html',
  styleUrls: ['./DebitarBolsa.component.css']
})
export class DebitarBolsaComponent implements OnInit {
